...
final class ProjectService: ProjectNetworkingProtocol {
    ...
    private var dummyIndivisualPuzzleData: [IndivisualPuzzleStatusModel] = [IndivisualPuzzleStatusModel(reviewId: 1, status: .init(isTodayReviewDay: false, hasReviewed: true, reviewDate: "2023-07-01"), puzzleAssetNumber: 2), IndivisualPuzzleStatusModel(reviewId: 1, status: .init(isTodayReviewDay: false, hasReviewed: true, reviewDate: "2023-07-07"), puzzleAssetNumber: 4), IndivisualPuzzleStatusModel(reviewId: 1, status: .init(isTodayReviewDay: false, hasReviewed: true, reviewDate: "2023-07-11"), puzzleAssetNumber: 7), IndivisualPuzzleStatusModel(reviewId: 1, status: .init(isTodayReviewDay: true, hasReviewed: false, reviewDate: "2023-07-19"), puzzleAssetNumber: 3)]
